...
parser.add_argument("--sam_checkpoint", type=str, default="./sam_model/sam_vit_b_01ec64.pth", help="sam checkpoint")
...
def train(args, snapshot_path):
    ...
    test_dataset = build_Dataset(args=args,data_dir=args.data_path + args.dataset, split="test_acdc_list",
                                 transform=data_transforms["valid_test"])
    # sampler
    ...
    mixStyle=MixStyle(p=0.5,alpha=2)
    # else:
    ...
    for _ in iterator:
        for i_batch, sampled_batch in enumerate(train_loader):
            ...
            if iter_num>args.mixed_iterations:
                volume_batch=mixStyle(volume_batch)
...
if __name__ == '__main__':
    ...
    for fold in range(args.n_fold):
        ...
        snapshot_path = "./Results/results_ACDC_all/fold_" + str(fold)
